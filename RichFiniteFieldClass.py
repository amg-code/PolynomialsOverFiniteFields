...
_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_8 = Integer(8)# This file contains the following Python Classes for computations with polynomials over finite fields and their extension fields 
# - RichFiniteField
