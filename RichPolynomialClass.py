...
_sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_0 = Integer(0)# This file contains the following Python Classes for computations with polynomials over finite fields and their extension fields 
# - RichPolynomial
